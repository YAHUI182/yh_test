sap.ui.define([
	...
	var excuteSure = true,
		iSuccess = 0,
		iFailed = 0;
	return BaseController.extend("zzfi0002.controller.Ratio", {
		formatter: formatter,
		/**
		...
		onBeforeRebindTable: function (oEvent) {
			...
			var sCycleID = '';
			if (this.byId("smartFilterRatio")) {
				sCycleID = this.byId("smartFilterRatio").getFilterData().Zzcycle;
			}
        ...
        */
	        // 2024/03/22 yahui add for Jira [SAP-981];
			var cycleString = ''; // 将界面选中的CycleId拼接上逗号SaveRatio时callFunction传给后端去处理；
			...
			this.getModel().callFunction("/SaveRatio", {
				method: "POST",
				urlParameters: {
