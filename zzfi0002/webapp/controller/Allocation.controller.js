sap.ui.define([
	...
	var excuteSure = true,
		iSuccess = 0,
		iFailed = 0;
	return BaseController.extend("zzfi0002.controller.Allocation", {
		formatter: formatter,
		/**
		...
		onBeforeRebindTable: function (oEvent) {
			...
			var sCycleID = '';
			if (this.byId("smartFilterAllocation")) {
				sCycleID = this.byId("smartFilterAllocation").getFilterData().Zzcycle;
			}
		...
		onPost: function (oEvent) {
			...
			this.getModel().callFunction("/RunAllocation", {
				method: "POST",
				urlParameters: {
