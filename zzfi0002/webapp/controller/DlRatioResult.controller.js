sap.ui.define([
	...
	var excuteSure = true,
		iSuccess = 0,
		iFailed = 0;
	return BaseController.extend("zzfi0002.controller.DlRatioResult", {
		formatter: formatter,
		/**
		...
		onBeforeRebindTable: function (oEvent) {
			...
			var sCycleID = '';
			if (this.byId("smartFilterDlRatioResult")) {
				sCycleID = this.byId("smartFilterDlRatioResult").getFilterData().Zzcycle;
			}
...
/**
 * DlRatioResult.view.xml文档
 * 界面自定义的Reverse按钮【smartTable:customToolbar】
 ...
 */
		onReverse: function (oEvent) {   
			...
			this.getModel().callFunction("/ReverseDlRatio", {   //对应SEGW Function Imports里的ReverseDlRatio
				method: "POST",
				urlParameters: {
