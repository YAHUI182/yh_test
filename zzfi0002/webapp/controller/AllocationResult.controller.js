sap.ui.define([
	...
	var excuteSure = true,
		iSuccess = 0,
		iFailed = 0;
	return BaseController.extend("zzfi0002.controller.AllocationResult", {
		formatter: formatter,
		/**
		...
		onBeforeRebindTable: function (oEvent) {
			...
			var sCycleID = '';
			if (this.byId("smartFilterAllocationResult")) {
				sCycleID = this.byId("smartFilterAllocationResult").getFilterData().Zzcycle;
			}
		...
		onReverse: function (oEvent) {
			...
			this.getModel().callFunction("/ReverseAllocation", {
				method: "POST",
				urlParameters: {
