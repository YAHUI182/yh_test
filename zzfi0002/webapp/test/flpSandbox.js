					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "CO Allocation Expense",
									"targetURL": "#zzfi0002-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"zzfi0002-display": {
								"semanticObject": "zzfi0002",
								"action": "display",
								"description": "CO Allocation Expense",
								"title": "CO Allocation Expense",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=zzfi0002",
									"url": sap.ui.require.toUrl("zzfi0002")
								}
							}
						}
					}
